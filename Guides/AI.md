...
- [Stunning Dashboard](https://stunning.so/dashboard)
- [Prompt Chainer](https://promptchainer.io/dashboard/settings)
- [Kaggle](https://www.kaggle.com/)
- [LeetCode](https://leetcode.com)
- [STTAbot AI Chatbot](https://app.sttabot.io/bot/ai_chatbot_agent_mem_debug_auditer/)
- [QuestMate](https://app.questmate.com/home)
- [Gitwit Projects](https://app.gitwit.dev/projects#)
- [AgentGPT](https://agentgpt.reworkd.ai/)
- [Socra Journey](https://socra.com/journey)
- [Cohere Playground](https://dashboard.cohere.ai/playground/embed)
- [AI21 Playground](https://studio.ai21.com/playground/complete?modelId=j2-jumbo)
- [Dust](https://dust.tt)
- [Forefront AI Chat](https://chat.forefront.ai/)
- [Jina Dev-GPT](https://github.com/jina-ai/dev-gpt)
- [WhatTheAI](https://whattheai.tech/)
- [ChatbotUI](https://www.chatbotui.com/)
- [Cebra AI](https://cebra.ai/)
- [TheSamur AI](https://thesamur.ai/?bl=en)
- [GPTAPI Chat](https://chat.getgptapi.com#/)
- [Patience AI](https://www.patience.ai/)
...
- [Hugging Face ChatGPT4](https://huggingface.co/spaces/ysharma/ChatGPT4)
...
- [LMSys Chat](https://chat.lmsys.org/)
- [Loom Use Case - Marketing](https://www.loom.com/use-case/marketing)
- [TheSamur AI - MyGPT](https://thesamur.ai/mygpt)
- [Open Assistant Dashboard](https://open-assistant.io/dashboard)
- [Cognosys AI](https://www.cognosys.ai/)
- [Open Assistant GitHub](https://github.com/LAION-AI/Open-Assistant)
- [Micro-GPT](https://github.com/muellerberndt/micro-gpt)
- [Text Generation Web UI](https://github.com/oobabooga/text-generation-webui)
- [Dolly V2 12B](https://huggingface.co/databricks/dolly-v2-12b)
- [GPT4All](https://github.com/nomic-ai/gpt4all)
- [Cohere Playground - Generate](https://dashboard.cohere.ai/playground/generate)
- [The Indie AI](https://www.theindieai.com/)
- [LeetCode Login](https://leetcode.com/accounts/login/?next=)
...
- [NVIDIA CUDA Downloads](https://developer.nvidia.com/cuda-downloads?target_os=Linux&target_arch=x86_64&Distribution=WSL-Ubuntu&target_version=2.0&target_type=deb_local)
